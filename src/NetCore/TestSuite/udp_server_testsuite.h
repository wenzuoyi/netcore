#ifndef UDP_SERVER_TESTSUITE_H_
#define UDP_SERVER_TESTSUITE_H_
#include "udp_endpoint.h"
#include <future>
namespace testsuite {
  class UDPServerTestSuite : public netcore::UDPEndPointEvent , std::mutex {
  public:
    UDPServerTestSuite();
    ~UDPServerTestSuite();
    void Start();
